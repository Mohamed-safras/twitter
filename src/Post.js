...
import VeificationUserIcon from "@material-ui/icons/VerifiedUser";
  ...
  return (
    <div className="post">
      ...
      <div className="post__body">
        <div className="post__header">
          <div className="post__header__text">
            <h4>
              Safras {""}
              <span>
                <VeificationUserIcon  className="verfidedBadge" />
                @safras
              </span>
            </h4>
            <MoreHorizIcon className="more" fontSize="small"/>
          </div>
        ...
        <img
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQNHlrRmMLZ27mm7Ib9wrtjg4ybxXDA6cQ6Mw&usqp=CAU"
          alt=""
        />
